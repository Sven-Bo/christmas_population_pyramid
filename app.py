...
df = pd.read_csv('data/Japan-1950.csv')
y = df['Age']
x1 = df['M']
x2 = df['F'] * -1
...
st.markdown(f"""
    ...
    unsafe_allow_html=True)
st.markdown("<h1 style='text-align: Center; color: white; text-shadow: 1.5px 1.5px #d4d4d4';>Merry Christmas 🎅</h1>", unsafe_allow_html=True)
st.text("")
st.text("")
